...
class MockDataService:
    ...
    @staticmethod
    def get_source_label_distribution() -> List[Dict]:
        """Phân phối nhãn theo nguồn (platform) — dùng cho grouped bar chart"""
        return [
            {"platform": "tiktok",   "label": 0, "label_name": "bình thường",   "count": 4120},
            {"platform": "tiktok",   "label": 1, "label_name": "offensive",      "count": 1025},
            {"platform": "tiktok",   "label": 2, "label_name": "hate speech",    "count": 1305},
            {"platform": "tiktok",   "label": -1,"label_name": "chưa gán nhãn", "count": 6000},
            {"platform": "threads",  "label": 0, "label_name": "bình thường",   "count": 2620},
            {"platform": "threads",  "label": 1, "label_name": "offensive",      "count": 672},
            {"platform": "threads",  "label": 2, "label_name": "hate speech",    "count": 798},
            {"platform": "threads",  "label": -1,"label_name": "chưa gán nhãn", "count": 4230},
        ]

    @staticmethod
    def get_topic_distribution() -> List[Dict]:
        """Phân phối bài viết theo chủ đề"""
        return [
            {"topic": "the_thao",   "total": 4820},
            {"topic": "chinh_tri",  "total": 3950},
            {"topic": "giai_tri",   "total": 3210},
            {"topic": "xa_hoi",     "total": 2780},
            {"topic": "kinh_te",    "total": 2340},
            {"topic": "cong_nghe",  "total": 1980},
            {"topic": "giao_duc",   "total": 1650},
            {"topic": "y_te",       "total": 1420},
            {"topic": "phap_luat",  "total": 1180},
            {"topic": "moi_truong", "total": 920},
        ]

    @staticmethod
    def get_topic_label_heatmap() -> List[Dict]:
        """Tỷ lệ phân phối nhãn theo chủ đề (%) — dùng cho heatmap"""
        return [
            {"topic": "the_thao",   "binh_thuong": 62.5, "offensive": 18.2, "hate_speech": 19.3},
            {"topic": "chinh_tri",  "binh_thuong": 41.8, "offensive": 22.4, "hate_speech": 35.8},
            {"topic": "giai_tri",   "binh_thuong": 71.2, "offensive": 15.6, "hate_speech": 13.2},
            {"topic": "xa_hoi",     "binh_thuong": 55.3, "offensive": 20.1, "hate_speech": 24.6},
            {"topic": "kinh_te",    "binh_thuong": 68.9, "offensive": 16.8, "hate_speech": 14.3},
            {"topic": "cong_nghe",  "binh_thuong": 73.4, "offensive": 14.2, "hate_speech": 12.4},
            {"topic": "giao_duc",   "binh_thuong": 76.1, "offensive": 12.5, "hate_speech": 11.4},
            {"topic": "y_te",       "binh_thuong": 69.7, "offensive": 15.9, "hate_speech": 14.4},
            {"topic": "phap_luat",  "binh_thuong": 57.2, "offensive": 23.6, "hate_speech": 19.2},
            {"topic": "moi_truong", "binh_thuong": 72.8, "offensive": 14.1, "hate_speech": 13.1},
        ]

    @staticmethod
    def get_text_length_stats() -> List[Dict]:
        """Thống kê phân phối độ dài văn bản theo nhãn và nền tảng"""
        return [
            {"platform": "tiktok",  "label": 0, "label_name": "bình thường",  "min": 8,  "q1": 42,  "median": 78,  "q3": 135, "max": 480, "mean": 92.4,  "stddev": 68.2},
            {"platform": "tiktok",  "label": 1, "label_name": "offensive",     "min": 10, "q1": 55,  "median": 98,  "q3": 162, "max": 520, "mean": 112.3, "stddev": 78.5},
            {"platform": "tiktok",  "label": 2, "label_name": "hate speech",   "min": 12, "q1": 60,  "median": 105, "q3": 175, "max": 490, "mean": 120.1, "stddev": 82.1},
            {"platform": "threads", "label": 0, "label_name": "bình thường",  "min": 15, "q1": 80,  "median": 152, "q3": 242, "max": 820, "mean": 178.6, "stddev": 112.4},
            {"platform": "threads", "label": 1, "label_name": "offensive",     "min": 18, "q1": 92,  "median": 168, "q3": 268, "max": 870, "mean": 195.2, "stddev": 125.3},
            {"platform": "threads", "label": 2, "label_name": "hate speech",   "min": 20, "q1": 98,  "median": 178, "q3": 285, "max": 910, "mean": 208.4, "stddev": 132.7},
        ]
